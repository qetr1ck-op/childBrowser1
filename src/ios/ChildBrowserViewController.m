...
- (void)webViewDidFinishLoad:(UIWebView*)sender
{
    ...
    self.backBtn.enabled = self.webView.canGoBack && !self.delegate.hideNavBar;
    self.fwdBtn.enabled = self.webView.canGoForward && !self.delegate.hideNavBar;
    self.refreshBtn.enabled = !self.delegate.hideNavBar;
    self.safariBtn.enabled = !self.delegate.hideNavBar;
